...
import com.israel.startupapi.services.PersonServices;
import com.israel.startupapi.util.MediaType;
...
public class PersonController {
    ...
    @CrossOrigin(origins = {"http://localhost:8080", "https://israel.com.br"})
    @PostMapping(
